...
export default function Main({ navigation }) {
    ...
    async function handleLike() {
        ...
        await api.post(`/devs/${user._id}/like`, null, { headers: { user: id } });
    ...
    async function handleDislike() {
        ...
        await api.post(`/devs/${user._id}/dislike`, null, { headers: { user: id } });
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.cardsContainer}>
                { users.length === 0
                    ? <Text style={styles.empty}>Nada a ser mostrado</Text>
